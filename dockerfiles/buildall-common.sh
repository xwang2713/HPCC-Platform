...
BASE_VER=$(git submodule status $SCRIPT_DIR/../vcpkg | cut -c2-9)  # The docker hub label for the platform-build-base image. Changes rarely.
...
GITHUB_ACTOR=xwang2713                      # The github action actor
