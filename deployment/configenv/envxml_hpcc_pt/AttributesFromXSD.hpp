...
############################################################################## */
#ifndef _ATTRIBUTESFROMXSD_HPP_
#define _ATTRIBUTESFROMXSD_HPP_
...
class AttributesFromXSD
{
 public:
   AttributesFromXSD(EnvHelper* peh);
  ...
  void setCompTree(IPropertyTree* pTree, IPropertyTree* schemaTree, bool allSubTypes);
