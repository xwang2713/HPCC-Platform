...
XXXXX_INCLUDE_DIR
XXXXX_LIBRARIES
</code></pre><p>(more can be defined, but must be at min the previous unless looking for only a binary)</p><p>For an example, see FindAPR.cmake</p>`,32),r=[o];function s(l,c,d,m,u,f){return i(),a("div",null,r)}const _=e(n,[["render",s]]);export{p as __pageData,_ as default};
