...
IF ("${COMMONSETUP_DONE}" STREQUAL "")
  ...
  if (WIN32)
    ...
    if (CMAKE_COMPILER_IS_GNUCXX OR CMAKE_COMPILER_IS_CLANGXX)
      ...
      SET (CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -frtti -fPIC -fmessage-length=0 -Werror=format -Wformat-security -Wformat-nonliteral -Wno-error=pedantic -pthread -Wuninitialized")
  ...
  if ( PLATFORM OR PLUGIN )
      set ( CMAKE_INSTALL_PREFIX "${INSTALL_HOME}" )
  else ( )
    set ( CMAKE_INSTALL_PREFIX "${INSTALL_HOME}/${version}/clienttools" )
