if ( NOT DESTDIR )
    if (MAKE_SNAP)
       set( PREFIX "/snap/hpcc-ce/current/opt" )
       set( DESTDIR "/var/snap/hpcc-ce/common" )
       set( ETC_PREFIX "/var/snap/hpcc-ce/common" )
    else()
       set( DESTDIR "" )
    endif()
endif()
...
if (MAKE_SNAP)
   set( INSTALL_HOME "/opt/${DIR_NAME}" )
else ()
   set( INSTALL_HOME "${INSTALL_DIR}" )
endif ()
