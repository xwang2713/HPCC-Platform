...
MACRO(DOCBOOK_TO_HTML _xsl_file _xml_file _out_dir _html_target _css_path _zip_target)
    IF(MAKE_DOCS)
       if("${_target_file}" STREQUAL "")
           set(_tareget "_generate_html_files")
       endif()
       ...
       ADD_CUSTOM_TARGET(${_html_target}
           COMMAND xsltproc --nonet --xinclude --stringparam html.stylesheet ${css_file_name} --stringparam generate.toc "book toc"  --param use.id.as.filename 1  ${_xsl_file} ${_xml_file}
